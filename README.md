...
This project presents a deep learning-based system for recognizing human emotions such as angry, calm, disgust, fearful, happy, neutral, sad, and surprised,from speech audio.
...
To test: download the file from the `samples/` folder, upload it on the [live demo] (https://emotion-recognition-from-speech-tmx6rpvptqphzfy8dvtvkx.streamlit.app/), and compare the predicted emotion against the true label above.
